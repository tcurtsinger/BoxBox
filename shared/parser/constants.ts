...
// Track IDs -> circuit name. The current set (0-42) is verified against the F1 25
// / 2026-pack appendix; the legacy ids (1, 8, 18, 21-25, 28) are the long-standing
// Codemasters values kept for older captures. trackId is i8, so -1 = unknown.
